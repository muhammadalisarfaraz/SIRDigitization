...
function SafetyHazardPosted({route, navigation}) {
...
//      console.log('data', data);
      ...
      data1 = data.filter(x => x.Status == 'Posted');
              ...
              <Swipeable
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    navigation.reset({
                      index: 0,
                      routes: [{name: 'Post to Server'}],
                    });
                    navigation.navigate('Post to Server', {
                      data: item,
                      index: index,
...
export default SafetyHazardPosted;