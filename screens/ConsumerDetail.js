...
function ConsumerDetail({ route, navigation }) {
  ...
  useEffect(() => {
    ...
    Postingdata.HazardImages.map((RBImgsub, index) => {
    ...
    /*
      ...
      RNFetchBlob.config({
        ...
        .then(resp => {
          ...
          detail.ImageFlag == "Y" ? insertImages(resp.surveyID, detail.ImageFlag, detail.HazardImages) : null;
          console.log('************************ end', detail.ImageFlag);
