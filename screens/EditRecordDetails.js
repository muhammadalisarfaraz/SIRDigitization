...
function EditRecordDetails({route, navigation}) {
  ...
  if (ParkRenovationV == 'YES') {
    ParkRenovationV = true;
  } else {
    ParkRenovationV = false;
  }

  let DispensaryRenovationV = route.params.data.DispensaryRenovation;
  if (DispensaryRenovationV == 'YES') {
    DispensaryRenovationV = true;
  } else {
    DispensaryRenovationV = false;
  }

  let SchoolRenovationV = route.params.data.SchoolRenovation;
  if (SchoolRenovationV == 'YES') {
    SchoolRenovationV = true;
  } else {
    SchoolRenovationV = false;
  }

  let DrinkingWaterV = route.params.data.DrinkingWater;
  if (DrinkingWaterV == 'YES') {
    DrinkingWaterV = true;
  } else {
    DrinkingWaterV = false;
  }

  let GarbageCleaningV = route.params.data.GarbageCleaning;
  if (GarbageCleaningV == 'YES') {
    GarbageCleaningV = true;
  } else {
    GarbageCleaningV = false;
  }
  ...
  if (PendingConnectionV == 'YES') {
    PendingConnectionV = true;
  } else {
    PendingConnectionV = false;
  }
  ...
  if (DisconnectionV == 'YES') {
    DisconnectionV = true;
  } else {
    DisconnectionV = false;
  }
  ...
  const [safetyhazarddataV, setsafetyhazarddataV] = useState(
    route.params.data.safetyhazardsid,
  );
  ...
  const [safetyhazarddata, setsafetyhazarddata] = useState([
    ...
    {
      id: 7,
      value: 'Placing of halogen lights near cloths or curtains',
      name: 'Placing of halogen lights near cloths or curtains',
    },
    {
      id: 8,
      value: 'Exposed wiring of outlets and cords',
      name: 'Exposed wiring of outlets and cords',
    },
    {id: 9, value: 'Faulty wiring', name: 'Faulty wiring'},

    {
      id: 10,
      value: 'Unsafe use of electrical appliances',
      name: 'Unsafe use of electrical appliances',
    },
    {
      id: 11,
      value: 'Illegal hook connections',
      name: 'Illegal hook connections',
    },
    {
      id: 12,
      value:
        'Unwarranted placement of TV and Internet cables on electricity poles',
      name: 'Unwarranted placement of TV and Internet cables on electricity poles',
    },
    {
      id: 13,
      value: 'HT Line or PMT adjacent to residence',
      name: 'HT Line or PMT adjacent to residence',
    },
  ]);
  ...
  function UpdateRecord() {
    ...
    AsyncStorage.getItem('RoshniBajiA').then(items => {
      ...
      data[index].NewConnection_Conversion =
        NewConnection_Conversion == true ? 'YES' : 'NO';
      data[index].theft = theft == true ? 'YES' : 'NO';
      data[index].ParkRenovation = ParkRenovation == true ? 'YES' : 'NO';
      data[index].DispensaryRenovation =
        DispensaryRenovation == true ? 'YES' : 'NO';
      ...
      data[index].safetyhazards =
        hazards == ''
          ? route.params.data.safetyhazards
          : safetyhazarddropdown.name;
      data[index].safetyhazardsid =
        hazards == ''
          ? route.params.data.safetyhazardsid
          : safetyhazarddropdown.id;
...
*/
    ...
    AsyncStorage.getItem('RoshniBajiA').then(items => {
      ...
      let data1 = data.filter(
        x => x.Status == 'Pending' && x.filterkey == route.params.otherParam,
      );
            ...
            <View style={{flex: 1}}>
              ...
              <View
                ...
                <View style={{flex: 0.5}}>
                  ...
                  />
                  {keAccountError ? (
                    <Text style={{marginBottom: 25, color: 'red'}}>
              ...
              <View
                ...
                <View style={{flex: 0.5}}>
                  ...
                  />
                  {contractnumberError ? (
                    <Text style={{marginBottom: 50, color: 'red'}}>
                      Contract Number must be 8 digits
                    </Text>
                  ) : (
                    <Text></Text>
                  )}
                  ...
                  <View style={{flex: 0.3, alignItems: 'flex-start'}}>
                    <View style={{flex: 0.5}}>
                      <Switch
                        ...
                        thumbColor={[
                          item.status ? '#7ab8e1' : 'rgba(192,144,194,255)',
                        ]}
                  ...
                  <View style={{flex: 0.3, alignItems: 'flex-start'}}>
                    <View style={{flex: 0.5}}>
                      <Switch
                        ...
                        onValueChange={() => {
                          setNewConnection_Conversion(
                            !NewConnection_Conversion,
                          );
                        }}></Switch>
                    </View>
                  </View>
              ...
              <View style={styles.containerscr4}></View>
              ...
              <Collapsible
                ...
                <View
                  ...
                  <View style={{flex: 0.3, alignItems: 'flex-start'}}>
                    <View style={{flex: 0.5}}>
                      <TextInput
                        style={{color: 'black', height: 50, width: '50%'}}
              ...
              <View style={{flexDirection: 'row', flex: 1, width: '96%'}}>
                <View style={{flex: 0.7, alignItems: 'flex-start'}}>
                  <Text style={{fontWeight: 'normal'}}>Safety Hazard </Text>
                </View>
              ...
              <View style={{flexDirection: 'row', flex: 1, width: '96%'}}>
                <View style={{flex: 0.7, alignItems: 'flex-start'}}>
                  <Text style={{fontWeight: 'normal'}}>Remarks </Text>
                </View>
